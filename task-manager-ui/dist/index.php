    ...
    <div class="view">
      <div class="viewHeader">
        ...
        <div class="functions">
          ...
          <div class="button"><a href="/7task/task-manager-ui/dist/completed.php">completed</a></div>
        ...
        <div class="list">
          ...
          if (isset($_SESSION['id'])) {  
            ...
            ?>
              ...
              <div class="info">
                <form method="" action="/7task/back-end.php/Completed-button.php" >
                <div class="button green"><button type="submit" name="com1">Completed</button></div>
                </form>
              </div>
            </li>
          ...
          if (isset($_SESSION['id'])) {  
            ...
            ?>
              ...
              <div class="info">
                <form method="" action="/7task/back-end.php/Completed-button.php" >
                  <div class="button green"><button type="submit" name="com2">Completed</button></div>
                </form>
              </div>
            </li>
            <li><i class="fa fa-square-o"></i><span>
            ...
            ?>
              ...
              <div class="info">
                <form method="" action="/7task/back-end.php/Completed-button.php" >
                  <div class="button green"><button type="submit" name="com3">Completed</button></div>
                </form>
              </div>
            </li>
            <li><i class="fa fa-square-o"></i><span>
            ...
            ?>
              ...
              <div class="info">
                <form method="" action="/7task/back-end.php/Completed-button.php" >
                  <div class="button green"><button type="submit" name="com4">Completed</button></div>
                </form>
              </div>
            </li>
            <li><i class="fa fa-square-o"></i><span>
            ...
            ?>
              ...
              <div class="info">
                <form method="" action="/7task/back-end.php/Completed-button.php" >
                  <div class="button green"><button type="submit" name="com5">Completed</button></div>
                </form>
              </div>
            </li>
            <li><i class="fa fa-square-o"></i><span>
            ...
            ?>
              ...
              <div class="info">
                <form method="" action="/7task/back-end.php/Completed-button.php" >
                  <div class="button green"><button type="submit" name="com6">Completed</button></div>
                </form>
              </div>
            </li>
            <li><i class="fa fa-square-o"></i><span>
            ...
            ?>
              ...
              <div class="info">
                <form method="" action="/7task/back-end.php/Completed-button.php" >
                  <div class="button green"><button type="submit" name="com7">Completed</button></div>
                </form>
              </div>
            </li>
          </ul>
